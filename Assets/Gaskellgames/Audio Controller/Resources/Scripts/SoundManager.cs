...
{
    public class SoundManager : GGMonoBehaviour
    {
        #region Variables
        ...
        [SerializeField, LineSeparator(true, false), Header("Sound Library"), Space]
        private SoundData[] music;
        
        [SerializeField]
        private SoundData[] soundFX;
        
        [SerializeField]
        private SoundData[] environment;
        
        [SerializeField]
        private SoundData[] menuUI;

        [SerializeField, LineSeparator(true, false), Header("Playlists Library"), Space]
        ...
        private void Awake()
        {
            ...
            {
                Log("Duplicate SoundController destroyed", LogType.Warning);
                Destroy(gameObject);
                return;
            }
        }
