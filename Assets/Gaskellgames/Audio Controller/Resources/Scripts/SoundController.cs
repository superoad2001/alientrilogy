...
{
    public class SoundController : GGMonoBehaviour
    {
        #region Variables
        ...
        [SerializeField]
        private TMP_Text songNameHUD;
        
        [SerializeField]
        private TMP_Text artistNameHUD;
        
        [SerializeField]
        private Image albumArtworkHUD;
        ...
        [SerializeField]
        private bool stopEnvironment = true;
        
        [SerializeField]
        private bool stopSoundFX = true;
        
        [SerializeField]
        private bool stopMenuUI = true;

        //[Header("Play Music on Load Scene")] [Space]

        [SerializeField]
        private musicOnLoadOptions playOnLoad;
        
        [SerializeField]
        private string trackID = "";
        
        [SerializeField]
        private Sprite albumArtwork;
        ...
        private List<string> tracksPlayed;
        
        [ReadOnly, SerializeField]
        private List<string> tracksUnplayed;
