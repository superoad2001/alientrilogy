...
public class jefe3_al2 : MonoBehaviour
{
	public int vida;
	...
	private void Update()
	{
		...
		{
		cuentavidae.text = "CAPITAN THOR: "+vida;
		}
		if(manager.datosconfig.idioma == "en")
		{
		cuentavidae.text = "CAPITAIN THOR: "+vida;
		}
		if(manager.datosconfig.idioma == "cat")
		{
		cuentavidae.text = "CAPITA THOR: "+vida;
		}
		if (vida <= 0 && manager.datosserial.tengocoche == 1)
		{
			SceneManager.LoadScene("mundo_abierto_al2");
		}
		if (vida <= 0 && manager.datosserial.tengocoche == 0)
		{
			SceneManager.LoadScene("mejora3_al2");
		}
	}
	public void disparo()
	{
