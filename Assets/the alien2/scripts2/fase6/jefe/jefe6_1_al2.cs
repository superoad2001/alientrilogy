...
public class jefe6_1_al2 : MonoBehaviour
{
	public int vida;
	...
	private void Update()
	{
		...
		{
		cuentavidae.text = "REY DE LOS PIRATAS: "+vida;
		}
		if(manager.datosconfig.idioma == "en")
		{
		cuentavidae.text = "PIRATE KING: "+vida;
		}
		if(manager.datosconfig.idioma == "cat")
		{
		cuentavidae.text = "REI DELS PIRATES"+vida;
		}
		if (vida <= 0)
		{
			SceneManager.LoadScene("final_a_al2");
		}
	}
	public void disparo()
	{
