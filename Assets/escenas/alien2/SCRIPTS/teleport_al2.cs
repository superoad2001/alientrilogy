...
public class teleport_al2 : MonoBehaviour
{
    ...
    private void OnCollisionStay(Collision col)
	{
		if (col.gameObject.tag == "Player")
		{
			...
			if (controles.al2_3d.interactuar.ReadValue<float>() > 0f && tipoTP2 == 0 )
			{
            ...
            else if (controles.al2_3d.interactuar.ReadValue<float>() > 0f && tipoTP2 == 1 && bloqueada == false)
			{
    ...
    private void OnTriggerStay(Collider col)
	{
		if (col.gameObject.tag == "Player")
		{
            ...
            else if (controles.al2_3d.interactuar.ReadValue<float>() > 0f && tipoTP2 == 1)
			{
				col.gameObject.transform.position = objetoTP.transform.position + new Vector3(0, 1.5f, 0);
			}
