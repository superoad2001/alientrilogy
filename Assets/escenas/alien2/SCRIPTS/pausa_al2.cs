...
public class pausa_al2 : MonoBehaviour
{
    ...
    [SerializeField]
	public misiones_al2 dmisiones;
    [SerializeField]
	public notas_al2 dnotas;
    ...
    public void Update()
    {
        ...
        string.Concat("Enemigos asesinados : ",manager.datosserial.aliensderrotados,"\n",
        ...
        if(mapaact == true)
        {
            if(controles.al2_UI.ubi.ReadValue<float>() > 0)
            {
                ubicar();
            }

            xmapC = controles.al2_3d.UIX.ReadValue<float>();
            ymapC = controles.al2_3d.UIY.ReadValue<float>();
        ...
        {
            boton = controles.al2_UI.menu1.ReadValue<float>();
        }
        else if(modo == 1)
        {
            boton = controles.al2_UI.menu2.ReadValue<float>();
        }
        else if(modo == 2)
        {
            boton = controles.al2_UI.menu1.ReadValue<float>();
    	...
    	if(controlact == true)
        {
        botonb = controles.al2_UI.atras.ReadValue<float>();
        }
